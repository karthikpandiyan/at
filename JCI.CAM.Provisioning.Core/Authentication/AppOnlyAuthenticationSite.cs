...
namespace JCI.CAM.Provisioning.Core.Authentication
{
    ...
    public class AppOnlyAuthenticationSite : IAuthentication
    {
        ...
        /// <summary>
        /// Gets or sets Site Url for hosting your SharePoint Request list for Site Provisioning.
        ...
        {
            LogHelper.LogInformation("JCI.CAM.Provisioning.Core.Authentication.AppOnlyAuthenticationSite.GetAuthenticatedContext -  Initializing AppOnly Authentication context", LogEventID.InformationWrite);
            this.EnsureToken();
        ...
        public ClientContext GetAuthenticatedContextForGivenUrl(string siteUrl)
        {
            LogHelper.LogInformation("JCI.CAM.Provisioning.Core.Authentication.AppOnlyAuthenticationSite.GetAuthenticatedContext -  Initializing AppOnly Authentication context", LogEventID.InformationWrite);
            this.EnsureToken();
            var ctx = TokenHelper.GetClientContextWithAccessToken(siteUrl, this.AccessToken);
            return ctx;
        }
