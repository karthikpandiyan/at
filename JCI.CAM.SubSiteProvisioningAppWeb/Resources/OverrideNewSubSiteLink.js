...
function SubSiteOverride_OverrideLinkToAppUrl() {
    ...
    var url = JCI_CAM_SubSiteSetting_AppWebUrl +"?SPHostUrl=" + encodeURIComponent(_spPageContextInfo.webAbsoluteUrl);
    if (link != undefined) {
...
if (typeof (NotifyScriptLoadedAndExecuteWaitingJobs) == "function") {
    NotifyScriptLoadedAndExecuteWaitingJobs("OverrideNewSubSiteLink.js");
}